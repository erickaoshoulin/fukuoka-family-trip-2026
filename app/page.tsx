...
const dayPlans: DayPlan[] = [
  {
    ...
    stops: [
      ...
      {
        name: "The Royal Park Canvas Fukuoka Nakasu",
        detail: "住宿｜Day 1–4 的行程基地",
  ...
  },
  {
    ...
    stops: [
      {
        name: "北九州市立生命之旅博物館",
        detail: "上午主景點｜JR Space World 站步行約 5 分鐘",
  ...
  },
  {
    ...
    stops: [
      ...
      {
        name: "FORZA 博多站筑紫口Ⅱ",
        detail: "住宿｜Day 5–8 的行程基地",
        mapQuery: "ホテルフォルツァ博多駅筑紫口Ⅱ 福岡",
        kind: "spot",
      },
    ],
    dinner: "18:15 燒肉泰元",
  ...
  },
  {
    ...
    stops: [
      ...
      {
        name: "Canal City Hakata",
        detail: "下午購物｜Disney Store、Loft、Sanrio、噴水秀（依時間）",
        mapQuery: "Canal City Hakata",
        kind: "shopping",
      },
      {
        name: "博多站 AMU Plaza・KITTE",
        detail: "傍晚慢慢逛，回 FORZA 飯店整理行李",
        mapQuery: "AMU Plaza Hakata KITTE Hakata",
        kind: "shopping",
      },
      {
        name: "博多華味鳥 博多駅筑紫口店",
        detail: "18:00｜晚餐已訂位｜2 大 2 小｜FORZA 飯店步行約 5 分鐘",
        mapQuery: "博多華味鳥 博多駅筑紫口店 福岡",
        kind: "food",
      },
    ],
    dinner: "18:00 華味鳥",
  ...
  },
  {
    ...
    stops: [
      {
        name: "博多港・Bayside Place Hakata",
        detail: "推薦搭高速船｜建議提前 20–30 分鐘到現場購票",
